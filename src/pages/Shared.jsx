...
import { pmTag, PAYMENT_METHODS } from '../lib/paymentMethods'
...
export default function Shared({ selectedMonth }) {
  ...
  const sharedExpenses = transactions
    ...
    .filter(tx => filterPM === 'all' || (tx.payment_method || 'efectivo') === filterPM)
    ...
    <div>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.8rem', flexWrap: 'wrap', gap: '0.5rem' }}>
          ...
          <select value={filterPM} onChange={e => setFilterPM(e.target.value)} style={{ width: 'auto', fontSize: '0.82rem', padding: '0.35rem 0.65rem' }}>
